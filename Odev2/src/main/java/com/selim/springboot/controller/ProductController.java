...
import com.selim.springboot.converter.ProductConverter;
...
import com.selim.springboot.exception.UrunNotFoundException;
...
public class ProductController {
    ...
    public MappingJacksonValue findProductById(@PathVariable Long id){
        ...
        ProductDto productDto = ProductConverter.INSTANCE.convertUrunToUrunDto(urun);
    ...
    public ProductDetailDto findProductDtoById(@PathVariable Long id){
        ...
        ProductDetailDto productDetailDto = ProductConverter.INSTANCE.convertUrunToUrunDetayDto(urun);
    ...
    public ResponseEntity<Object> saveProduct(@RequestBody ProductDto productDto){
        ...
        Urun urun = ProductConverter.INSTANCE.convertUrunDtoToUrun(productDto);
    ...
    public List<ProductDetailDto> findAllProductByCategoryId(@PathVariable Long kategoriId){
        ...
        List<ProductDetailDto> productDetailDtoList = ProductConverter.INSTANCE.convertAllUrunListToUrunDetayDtoList(urunList);
